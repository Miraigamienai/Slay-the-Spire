...
{
public:
    Wound():Abstraction::CardPrototype<Wound>(RUtil::AtlasRegionID::_status_wound, RUtil::Cards_Text_ID::Wound, Rarity::common, Type::status, Color::colorless, Target::self, 100, 0, 0, 0){}
