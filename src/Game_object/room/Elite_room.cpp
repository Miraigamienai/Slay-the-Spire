#include "Game_object/room/Elite_room.hpp"//the hpp
...
namespace Room{
Elite_room::Elite_room():Rooms(Room_type::Elite),m_group_name(Monster::GroupName::Red_Slaver),ending_battle(false),ending_battle_timer(0.25F){
    m_wait_timer=0.0F;
}
...
void Elite_room::update(Dungeon::Dungeon_shared &dungeon_shared){
    if(ending_battle){
