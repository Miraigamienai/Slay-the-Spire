...
{
public:
    Power_through():Abstraction::CardPrototype<Power_through>(RUtil::AtlasRegionID::_red_skill_power_through,RUtil::Cards_Text_ID::Power_Through,Rarity::uncommon,Type::skill,Color::red,Target::self,1,0,15,0){}
