...
{
public:
    Twin_strike():Abstraction::CardPrototype<Twin_strike>(RUtil::AtlasRegionID::_red_attack_twin_strike,RUtil::Cards_Text_ID::Twin_Strike,Rarity::common,Type::attack,Color::red,Target::enemy,1,5,0,0){}
