...
class Sentry final:public Abstraction::Monster_move_tracker<2, SentryAction>
{
public:
    Sentry(float offset_x, float offset_y, RUtil::Random& rng);
    ~Sentry()override=default;
    void Action(Dungeon::Dungeon_shared &dungeon_shared) override;
    void next_move(Dungeon::Dungeon_shared &dungeon_shared) override;
private:
    bool first_move,is_second;
    static int counter;
    static constexpr float WIDTH=170.0F*Setting::SCALE,
                           HEIGHT=260.0F*Setting::SCALE,
                           HB_OFFSET_X=0.0F,
