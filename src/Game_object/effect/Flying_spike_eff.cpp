...
namespace Effect{
    ...
    void Flying_spike_eff::Initial(float x, float y, float speed_x, float speed_y, float angle, Uint32 color){
        this->is_done=false;
        this->duration=DUR;
        this->color=color;
        this->color_a=0.0F;
        ...
        this->angle = angle + RUtil::Random::GetRandomFloat(-5.0F, 5.0F);
    }
