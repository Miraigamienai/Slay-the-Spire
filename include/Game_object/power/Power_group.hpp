...
public:
    ...
    //events
    void at_round_end(Dungeon::Dungeon_shared &dungeon_shared, const std::shared_ptr<Character::Characters> &target)const{for(const auto&it:box)it->at_round_end(dungeon_shared,target);}
