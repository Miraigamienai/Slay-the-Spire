...
{
public:
    Weak_power(Character::CharacterType owner_type):Powers(RUtil::Powers_Text_ID::Weakened, RUtil::AtlasRegionID::_48_weak, RUtil::AtlasRegionID::_128_weak, PowerType::debuff, true, false, owner_type){}
