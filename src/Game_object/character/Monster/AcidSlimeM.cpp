...
namespace Monster{
    AcidSlimeM::AcidSlimeM(float offset_x, float offset_y, RUtil::Random& rng)
        :AcidSlimeM(offset_x, offset_y, rng.NextInt(MIN_HP, MAX_HP+1)){}
    
    AcidSlimeM::AcidSlimeM(float offset_x, float offset_y, int HP)
        :Abstraction::Monster_move_tracker<2, AcidSlimeMAction>(offset_x, offset_y, WIDTH, HEIGHT, HB_OFFSET_X, HB_OFFSET_Y, HP, IMG){}
